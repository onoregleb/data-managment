...
def load_wallets(**context):
    ...
    values = [(w['address'], w.get('transaction_count', 0), w.get('added_at'), w.get('last_updated')) for w in wallets]
...
with DAG(
    ...
    # Pipeline
    [extract_wallets_task, extract_transactions_task] >> load_wallets_task >> load_transactions_task >> stats_task
